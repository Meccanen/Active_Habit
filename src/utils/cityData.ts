// Türkiye'nin 81 ili ve Pakistan'ın önde gelen şehirleri — namaz vakti projesinden
// birebir taşındı. Hızlı şehir seçimi (özellikle otomatik konum reddedildiğinde
// veya arama sonucu bulunamadığında) için kullanılıyor.
...
export const PAKISTAN_CITIES = [
  ...
  { id: 16, name: "Gilgit",          urdu: "گلگت",             latitude: 35.9220,  longitude: 74.3089  },
  { id: 17, name: "Muzaffarabad",    urdu: "مظفرآباد",         latitude: 34.3700,  longitude: 73.4700  },
  // Arkadaşınızın eklenmesini istediği şehirler:
  { id: 18, name: "Muzaffargarh",    urdu: "مظفر گڑھ",         latitude: 29.5136,  longitude: 71.1932  },
  { id: 19, name: "Dera Ghazi Khan", urdu: "ڈیرہ غازی خان",   latitude: 30.0564,  longitude: 70.6340  },
  { id: 20, name: "Rahim Yar Khan",  urdu: "رحیم یار خان",    latitude: 28.4202,  longitude: 70.2952  },
  { id: 21, name: "Dera İsmail Khan",urdu: "ڈیرہ اسماعیل خان",latitude: 31.8340,  longitude: 70.9020  },
  { id: 22, name: "Mardan",          urdu: "مردان",            latitude: 34.1985,  longitude: 72.0404  },
  { id: 23, name: "Abbottabad",      urdu: "ایبٹ آباد",        latitude: 34.1480,  longitude: 73.1990  },
  { id: 24, name: "Swabi",           urdu: "صوابی",            latitude: 34.1208,  longitude: 72.4702  },
  { id: 25, name: "Mingora",         urdu: "منگورہ",           latitude: 34.7730,  longitude: 72.3600  },
